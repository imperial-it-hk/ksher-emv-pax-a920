...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = ctx.getResources().getDimensionPixelSize(com.evp.payment.ksher.R.dimen.common_circle_width) + 1;
        mBarColor = ctx.getResources().getColor(com.evp.payment.ksher.R.color.colorPrimaryDark);
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(com.evp.payment.ksher.R.dimen.progress_circle_radius);
    }
